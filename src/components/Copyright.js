...
const Copyright = () => {
  ...
  return (
    <section className='mt-24 pb-12 bg-[rgb(59,174,167)]' data-aos='fade-up'>
      <div className='container mx-auto'>
        <div className='flex flex-col items-center text-center md:text-left  lg:flex-row justify-between gap-y-8'>
          ...
          <div className='-order-1 md:order-1'>
            <div className='w-[60px] h-[60px] flex items-center justify-center rounded-full bg-[#555454] hover:bg-accent-secondary cursor-pointer group'>
           <div className='text-3xl text-white group-hover:scale-110 transition-all'>
                {icon}
              </div>
            </div>
          </div>
